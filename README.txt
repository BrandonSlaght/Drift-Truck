...
Physics:  Truck will move left and right at a constant rate, as trucks do.  However, since the ground is very slippery it is also drifting all the time as is moves forward and backwards and is affectrd by drag.  There is also gravity pulling everything down
